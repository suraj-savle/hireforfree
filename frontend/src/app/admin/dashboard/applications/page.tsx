    ...
    <div className="space-y-6 pb-12">
      ...
      {isPanelOpen && selectedApp && (
        <>
          ...
          {/* Panel */}
          <div className="fixed top-0 right-0 h-full w-full max-w-2xl bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-out overflow-y-auto animate-slide-in-right">
            {/* Header */}
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex flex-col items-center text-center border-b border-[#272d68]/10 pb-6">
                <div className="relative w-28 h-28 rounded-2xl bg-linear-to-br from-[#272d68] to-[#08a4a3] overflow-hidden shadow-lg mb-4">
