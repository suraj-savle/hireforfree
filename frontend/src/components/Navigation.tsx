...
import { UserPlus, Briefcase, X, Menu } from "lucide-react";
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/95 backdrop-blur-md border-b border-[#08a4a3]/10 shadow-lg"
          : "bg-transparent"
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          {/* 1. Left Container (Logo area) */}
          <div className="flex-1 flex justify-start">
            <Link href="/" className="flex items-center group">
              <span className="font-extrabold text-xl md:text-4xl text-[#272d68]">
                Hire
              </span>
              <span className="font-extrabold text-xl md:text-4xl text-[#08a4a3]">
                4
              </span>
              <span className="font-extrabold text-xl md:text-4xl text-[#272d68]">
                Free
          ...
          {/* 2. Middle Container (Centered Desktop Navigation Links) */}
          <div className="hidden md:flex flex-initial justify-center items-center space-x-8 mx-auto">
            <Link
              href="/about"
              className="text-[#272d68]/80 hover:text-[#08a4a3] text-sm font-semibold transition-all duration-300 hover:scale-105 whitespace-nowrap"
            >
              About
            </Link>
            <Link
          ...
          {/* 3. Right Container (Desktop Auth Actions) */}
          <div className="hidden md:flex flex-1 justify-end items-center space-x-4">
            <Link
              href="/login"
              className="text-[#272d68]/80 hover:text-[#272d68] text-sm font-semibold transition-all duration-300 hover:scale-105"
            >
              Log In
            </Link>
